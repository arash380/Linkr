 ...
 */
@Entity
@IdClass(WorkPackageEstimateToCompletionId.class)
@Table(name = "work_package_estimate_to_completion")
public class WorkPackageEstimateToCompletion {
    ...
    /**
     * P1PlannedDays for the EC.
     */
    private float p1PlannedDays;

    /**
     * P2PlannedDays for the EC.
     */
    private float p2PlannedDays;

    /**
     * P3PlannedDays for the EC.
     */
    private float p3PlannedDays;

    /**
     * P4PlannedDays for the EC.
     */
    private float p4PlannedDays;

    /**
     * P5PlannedDays for the EC.
     */
    private float p5PlannedDays;

    /**
     * JSPlannedDays for the EC.
     */
    private float jsPlannedDays;

    /**
     * SSPlannedDays for the EC.
     */
    private float ssPlannedDays;

    /**
     * DSPlannedDays for the EC.
     */
    private float dsPlannedDays;

    /**
     * Percentage complete for EC.
     */
    ...
    public void setProject(Project project) {
        ...
        if (this.getWorkPackage() != null && this.
                workPackage.getProject() == null) {
